...
// Asegúrate de importar el componente StudentActions con la ruta correcta
import StudentActions from './components/StudentActions'; // Ruta corregida
                ...
                {rows.map((row) => (
                  <TableRow key={row.document} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    ...
                    <TableCell align="right">
                      <StudentActions studentId={row.document} /> {/* Componente para las acciones */}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
